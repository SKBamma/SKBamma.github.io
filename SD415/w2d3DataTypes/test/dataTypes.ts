...
import { ucFirst,  checkSpam, truncate, extractCurrencyValue, getMaxSubSum, camelize } from "../src/app.js";


//mocha test of ucFirst
...
// mocha test of truncate
describe("truncate", function() {
  it("truncate the long string to the given length (including the ellipsis)", function() {
    assert.equal(truncate("What I'd like to tell on this topic is:", 20),
      "What I'd like to te…"
    );
  });
