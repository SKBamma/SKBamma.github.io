...
import { firstLast, replaceEnds, higho, square, absVal  } from "../src/app.js"; 
 import { calculateDailyTotalDuration,calculateTotalDuration, getAllSession, getAllSessionsForUser, getAllDurations  } from "../src/app.js";
...
describe("exam2 coding", function () {
    ...
    it("replaceEnds 6124", function () {
        /*Use slice and splice to write TypeScript code for the replaceEnds function.  
        replaceEnds should be a pure function. first two number arguments replace the first and second elements 
        of the array, last two number arguments replace the last two elements of the array*/
...
describe("fitness tracking", function () {
    ...
    it("getAllSessions", function () {
        assert.deepEqual(getAllSession(dailyRecord), allSessions);
    });
