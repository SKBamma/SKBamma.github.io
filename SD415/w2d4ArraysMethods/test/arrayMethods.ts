...
import { doubleNumbers, doubleAge, filterAllEvenNumber, filterAgeGreaterThan10, findEvenNum, findEvenAge, includesEvenNum, includesEvenAge } from "../src/app.js";
...
describe("map practice", function () {
    ...
    it("doubles age", function () {
        assert.deepEqual(doubleAge(peopleArray),
...
describe("filter practice", function () {
    ...
    it("filter all age > 10", function () {
        assert.deepEqual(filterAgeGreaterThan10(peopleArray),
