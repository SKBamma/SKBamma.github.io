...
export function topSalary(salaries: Salaries): string | null {
    let maxSalary = 0;
...
export function countStudentsInClassroom(classrooms: Classroom[], roomNumber: number): number | null {
...
export function findStudentsOlderThan(classrooms: Classroom[], minAge: number): { student: Student, classroomName: string }[]  {
    const result: { student: Student, classroomName: string }[] = [];
...
*/
export function averageStudentAge(classrooms: Classroom[]): number | null {
