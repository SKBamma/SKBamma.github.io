...
import { classrooms, collectRoomNumbers, collectRoomsAndCapacities, collectLabeledRoomCaps, countStudentsInClassroom, findClassroomsWithCapacity, findStudentsOlderThan, averageStudentAge } from '../src/app.js';
describe("classroom embedded objects", function () {
    it("collectRoomNumbers ", function () {
        assert.deepEqual(collectRoomNumbers(classrooms), [101, 102, 103]);
    });
